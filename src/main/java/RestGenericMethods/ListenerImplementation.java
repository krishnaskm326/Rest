...
public class ListenerImplementation implements ITestListener {
	...
	public void onTestFailure(ITestResult result) {
		...
		try {
			String screenShotName = JSONUtility.getScreenShot(BaseClassAPI.driver,result.getMethod().getMethodName());
		...
		String MethodName = result.getMethod().getMethodName();
		EventFiringWebDriver edriver = new EventFiringWebDriver(BaseClassAPI.driver);
